...
from models.gnn import MessagePassing
...
class GeoLayer(MessagePassing):
    ...
    def message(self, x_i, x_j, edge_index, num_nodes):
        ...
        :param x_i: [E x head x output_channels]
        :param x_j: [E x head x output_channels]
        :param edge_index:
        :param num_nodes:
        :return:
        """
        num_nodes = int(num_nodes)# torch.tensor(num_nodes).to(edge_index.device).long()
